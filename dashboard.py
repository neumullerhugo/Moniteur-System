...
# Bloquer la récursion de PyInstaller immédiatement
if __name__ == '__main__':
    multiprocessing.freeze_support()

# CONSTANTE ANTI-SPAM CMD (Windows)
# Force toutes les commandes système en tâche de fond à masquer leur fenêtre cmd
import subprocess
if sys.platform.startswith('win'):
    su = subprocess.STARTUPINFO()
    su.dwFlags |= subprocess.STARTF_USESHOWWINDOW
    su.wShowWindow = subprocess.SW_HIDE
    subprocess.STARTUPINFO = lambda *args, **kwargs: su
...
class PCWatcher(ctk.CTk):
    def __init__(self):
        ...
        self.title("Moniteur Système Pro")
        self.geometry("480x680") # Un peu plus grande pour respirer en bas
        self.resizable(False, False)

        self.title_label = ctk.CTkLabel(self, text="📊 MONITEUR SYSTÈME PRO", font=("Arial", 22, "bold"))
    ...
    def get_progress_color(self, percentage):
        ...
        elif percentage < 80: return "#e67e22"
        else: return "#e74c3c"
